        ...
        return this.each(function(){
            ...
            if(_2f9){
                ...
                $.data(this,"validatebox",{
                    options:$.extend({},$.fn.validatebox.defaults,$.fn.validatebox.parseOptions(this),_2f7)
                    });
            }
            _2e8(this);
        });
...
$.fn.validatebox.defaults={
    required:false,
    validType:null,
    missingMessage:"Kolom harus diisi!",
    invalidMessage:null,
    rules:{
        email:{
...
(function($){
    ...
    function _30a(data){
        ...
        for(var name in data){
            ...
            //CHANGE
            $("input:text[name="+name+"]",form).val(val);
            $("input:hidden[name="+name+"]",form).val(val);
            $("input:radio[name="+name+"]",form).val([val]);
        ...
        return this.each(function(){
            ...
            if(_324){
                ...
                _324=$.data(this,"numberbox",{
                    options:$.extend({},$.fn.numberbox.defaults,$.fn.numberbox.parseOptions(this),_321)
                    });
                $(this).removeAttr("disabled");
                $(this).css({
                    imeMode:"disabled"
        ...
        return this.each(function(){
            ...
            if(_347){
                ...
                _347=$.data(this,"calendar",{
                    options:$.extend({},$.fn.calendar.defaults,$.fn.calendar.parseOptions(this),_345)
                    });
                init(this);
            }
        ...
        return this.each(function(){
            ...
            if(_35a){
                ...
                _35a=$.data(this,"spinner",{
                    options:$.extend({},$.fn.spinner.defaults,$.fn.spinner.parseOptions(this),_357),
                    spinner:init(this)
                    });
                $(this).removeAttr("disabled");
            }
        ...
        return this.each(function(){
            ...
            if(_366){
                ...
                $.data(this,"numberspinner",{
                    options:$.extend({},$.fn.numberspinner.defaults,$.fn.numberspinner.parseOptions(this),_363)
                    });
            }
            _35f(this);
        });
        ...
        return this.each(function(){
            ...
            if(_380){
                ...
                $.data(this,"timespinner",{
                    options:$.extend({},$.fn.timespinner.defaults,$.fn.timespinner.parseOptions(this),_37d)
                    });
                _369(this);
            }
        });
    ...
    return this.each(function(){
        ...
        if(_546){
            ...
            $.data(this,"propertygrid",{
                options:$.extend({},$.fn.propertygrid.defaults,$.fn.propertygrid.parseOptions(this),_543)
                });
        }
        _53d(this);
    });
...
$.fn.treegrid=function(_5e0,_5e1){
    ...
    return this.each(function(){
        ...
        if(_5e3){
            ...
            $.data(this,"treegrid",{
                options:$.extend({},$.fn.treegrid.defaults,$.fn.treegrid.parseOptions(this),_5e0),
                data:[]
            });
        }
        _560(this);
    ...
    return this.each(function(){
        ...
        if(_657){
            ...
            _657=$.data(this,"combo",{
                options:$.extend({},$.fn.combo.defaults,$.fn.combo.parseOptions(this),_655),
                combo:r.combo,
                panel:r.panel,
                previousValue:null
            });
    ...
    return this.each(function(){
        ...
        if(_68d){
            ...
            _68d=$.data(this,"combobox",{
                options:$.extend({},$.fn.combobox.defaults,$.fn.combobox.parseOptions(this),_68a)
                });
            _688(this);
            _67c(this,_67a(this));
        }
...
$.fn.combotree=function(_6a3,_6a4){
    ...
    return this.each(function(){
        ...
        if(_6a6){
            ...
            $.data(this,"combotree",{
                options:$.extend({},$.fn.combotree.defaults,$.fn.combotree.parseOptions(this),_6a3)
                });
        }
        _697(this);
    });
    ...
    return this.each(function(){
        ...
        if(_6c4){
            ...
            _6c4=$.data(this,"combogrid",{
                options:$.extend({},$.fn.combogrid.defaults,$.fn.combogrid.parseOptions(this),_6c1)
                });
        }
        _6aa(this);
    });
...
$.fn.combogrid.parseOptions=function(_6c7){
    var t=$(_6c7);
    return $.extend({},$.fn.combo.parseOptions(_6c7),$.fn.datagrid.parseOptions(_6c7),{
...
$.fn.datebox=function(_6d8,_6d9){
    ...
    return this.each(function(){
        ...
        if(_6db){
            ...
            $.data(this,"datebox",{
                options:$.extend({},$.fn.datebox.defaults,$.fn.datebox.parseOptions(this),_6d8)
                });
        }
        _6c8(this);
    });
    ...
    return this.each(function(){
        ...
        if(_6f4){
            ...
            $.data(this,"datetimebox",{
                options:$.extend({},$.fn.datetimebox.defaults,$.fn.datetimebox.parseOptions(this),_6f1)
                });
        }
        _6de(this);
    });
