...
<TR>
	...
	<form id="myForm" name="myForm" method="post" action="act_index_kematian.php">
	<table align="left" style=' font-family: verdana; font-size: 11px;' width='100%' border='0' cellpadding='3' cellspacing='1'>
	<tr>
		<td width='1%'  align='center' bgcolor='#00CC00' colspan='4'><B>Search Indek Kematian</B></td>
	</tr>
	<tr bgcolor='#D1FDCC'>
		<td  width='200'>
		...
		<td colspan='3'>
			<select id="tipe_pasien" name="diagnosa">
