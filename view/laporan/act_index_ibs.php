...
######## Filter #########
if(@$_GET['cetak']!=''){
	$cari_tipe_ruan = $_GET["idr"];
	$id_tipepasien = $_GET["idtp"];
	$tgl_awal = $_GET["tgla"]; 
	$tgl_akhir = $_GET["tglb"]; 
...
rm_pasien_keluar.id_pasien, rm_pasien.nama_pasien, rm_pasien.alamat, 
COUNT(rm_tindakan_ruang_medis.id_tindakan_ruang_medis) AS jml, 
SUM(rm_tindakan_ruang_medis.tarif) AS tarif, 
...
FROM rm_pendaftaran, rm_pasien_keluar, rm_tindakan_ruang_medis, rm_pasien, rm_ruang, rm_tindakan, rm_detail_tindakan
...
rm_detail_tindakan.id_detail_tindakan = rm_tindakan_ruang_medis.id_tindakan_medis AND rm_detail_tindakan.id_tindakan=rm_tindakan.id_tindakan AND 
...
DATE(rm_pasien_keluar.tgl_keluar) BETWEEN '$tgl_awal' and '$tgl_akhir' $sql_where $sql_where2
