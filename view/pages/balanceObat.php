	...
	<div style="background-color: #fcfcfc;">
            <table id="inBahan" width="100%">
                <tr style="font-family: verdana; font-size: 11; font-weight: bold;" align="center">
                    <td><input id="id_obat_balance" name="id_obat_balance" type="hidden" value="" size="40">NAMA OBAT</td>
                    <td>JUMLAH</td>
                    <td>TIPE BALANCE</td>
                ...
                <tr align="center">
                    <td>
                        <div class="ausu-suggest">
                            <input type="text" id="obatBal" name="obatBal" size="30" onkeydown="
                                if (event.keyCode == 123){
                                    saveBahan();
                                    return false;
                                }"/>
                            <input type="" id="obatId" name="obatId" size="1" disabled />
                        </div>
                    </td>
                    <td>
                        <input type="text" id="jumlahObat" name="jumlahObat" onkeydown="
                            if (event.keyCode == 123){
                                saveBahan();
                                return false;
                            }"/>
