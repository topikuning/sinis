...
<div id="winSimpanDistObat" class="easyui-window" title="Form Simpan Obat" draggable="false" resizable="false" closable="false" collapsible="false" minimizable="false" maximizable="false" modal="true" closed="true" style="width:400px;height:220px;background: #fafafa;">
    <form name='frmSimpanDistObat' id='frmSimpanDistObat'>
        <table class='data' width="100%">
            ...
            <tr height="25">
                <td width='40%'>SEMUA</td>
                <td width='60%'>
                    <select name='allKirim' id='allKirim' >
