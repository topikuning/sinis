...
$RootMenu->AddMenuItem(198, $ReportLanguage->Phrase("DetailSummaryReportMenuItemPrefix") . $ReportLanguage->MenuPhrase("198", "MenuText") . $ReportLanguage->Phrase("DetailSummaryReportMenuItemSuffix"), "Laporan_Karcissmry.php", -1, "", "", TRUE);
$RootMenu->Render();
?>
</div>
<!-- End Main Menu -->
